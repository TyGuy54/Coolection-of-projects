...
class BG(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        bg_image = self.image = pygame.image.load("./graphics/enviorment/background.png").convert()
...
class Ground(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        ...
        # image
        ground_surface = pygame.image.load('./graphics/enviorment/ground.png').convert_alpha()
...
class Plane(pygame.sprite.Sprite):
    def __init__(self,groups, scale_factor):
        ...
        # sound
        self.jump_sound = pygame.mixer.Sound('./sound/sounds_jump.wav')
    ...
    def import_frames(self, scale_factor):
        self.frames = []
        for i in range(3):
            surface = pygame.image.load(f'./graphics/plane/red{i}.png')
...
class Obsicals(pygame.sprite.Sprite):
    def __init__(self, groups, scale_factor):
        super().__init__(groups)
        self.sprite_type = 'obstical'

        oriantation = choice(('up', 'down'))    
        surface = pygame.image.load(f'./graphics/obsticals/{choice((0,1))}.png').convert_alpha()
